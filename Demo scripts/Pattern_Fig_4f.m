...
% General
Simulation_time = 40000; % In seconds - overall simulation time
...
C0_I_end = 9.5; % New concentrition for Fast Inhibitor
...
%Reaction kinetics
k0 = 0.003; % 1/s - Supply rate of the componenets from the CSTR into the reaction media
